...
5. **Handle versioning through your own maintenance workflow**: do not point
   users back to the previous public repository or its update URLs.
...
Use your own local install guide or private repository documentation.
