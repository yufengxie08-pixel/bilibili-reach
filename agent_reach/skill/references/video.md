...
# 下载音频并切分为 ASR-ready WAV
bili audio BVxxx

# 现在也可直接转写 B站 URL / BV号
agent-reach transcribe "https://www.bilibili.com/video/BVxxx"
agent-reach transcribe "BVxxx"
```
...
| 无字幕音视频 | agent-reach transcribe（B站 URL/BV 号已内置支持） |
